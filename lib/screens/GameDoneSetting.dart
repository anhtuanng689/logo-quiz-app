...
class GameDoneSetting extends StatefulWidget {
  final int id;
  final int themeId;
  final String answer;
  const GameDoneSetting({Key key, this.id, this.themeId, this.answer})
      : super(key: key);
  @override
  _GameDoneSettingState createState() => _GameDoneSettingState();
}

class _GameDoneSettingState extends State<GameDoneSetting> {
